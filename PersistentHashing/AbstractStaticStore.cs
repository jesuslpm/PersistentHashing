...
{
    public unsafe abstract class AbstractStaticStore<TKey, TValue>: IDisposable
    {
        ...
        protected void ValidateHeader()
        {
            ...
            {
                throw new FormatException($"This is not a {nameof(AbstractStaticStore<TKey, TValue>)} file");
            }

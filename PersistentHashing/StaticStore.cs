...
{
    public unsafe sealed class StaticStore<TKey, TValue> : AbstractStaticStore<TKey, TValue>
    {
        ...
        public StaticStore(string filePathPathWithoutExtension, long capacity, Func<TKey, long> hashFunction,
    ...
    public unsafe sealed class StaticStore: AbstractStaticStore<MemorySlice, MemorySlice> 
    {

        private long initialDataFileSize;
        private int dataFileSizeGrowthIncrement;

        public StaticStore(string filePathPathWithoutExtension, long capacity, Func<MemorySlice, long> hashFunction = null,
